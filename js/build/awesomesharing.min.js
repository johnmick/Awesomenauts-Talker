...
"400px";$("#PLAY_BUTTON").click(k.playSounds);$("#SHARE_BUTTON").click(function(){window.location.href="./index.htm"});j=document.getElementById("PHRASES_MESSAGE");for(var b=0;b<a.length;b++){var d=document.createElement("span"),e=a[b].replace(/_/g,"");d.innerHTML=b===0?'"'+e+" ":b+1===a.length?e+'."':e+" ";j.appendChild(d);i.push(d)}return n};n.highlightNextPhrase=function(){g++;if(g!==0){i[g-1].style.fontWeight="normal";i[g-1].style.color="#FFFFFF"}if(g!==i.length){i[g].style.fontWeight="bold";
i[g].style.color="#D2FF60"}};n.reset=function(c){g=-1;if(c!==true){i[0].style.fontWeight="bold";i[0].style.color="#D2FF60"}else{i[i.length-1].style.fontWeight="normal";i[i.length-1].style.color="#FFFFFF"}}})();var o;(function(){function i(a){function b(q){var l={},m;for(m in q)l[m]=q[m];l.onload=AwesomeLoading.somethingLoaded;l.autoLoad=true;return l}if(a.UI!==undefined){j.UI={};for(var d=a.UI.SOUNDS,e=0;e<d.length;e++){var f=d[e];j.UI[f.id]=soundManager.createSound(b(f))}g=j.UI.UI_TITLE_MUSIC}for(var h in a.CHARACTERS){d=
